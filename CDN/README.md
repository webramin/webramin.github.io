...
به پست من در GitHub خوش آمدید! در این پست چند لینک CDN را نیز برای کپی راحت تر خواهم گذاشت.

## استفاده از لینک های CDN

می توانید لینک های CDN خود را به این شکل قرار دهید:
...
<script src="https://webramin.github.io/posts/data.js"></script>
```
